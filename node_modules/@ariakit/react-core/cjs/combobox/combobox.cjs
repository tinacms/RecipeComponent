...
var _QMCNFBPOcjs = require('../__chunks/QMCNFBPO.cjs');


var _BUKUAI2Fcjs = require('../__chunks/BUKUAI2F.cjs');
...
var useCombobox = _MFAH5VLWcjs.createHook.call(void 0, 
  function useCombobox2(_a) {
    ...
    const [valueUpdated, forceValueUpdate] = _TM5Y6AJUcjs.useForceUpdate.call(void 0, );
    ...
    _TM5Y6AJUcjs.useUpdateLayoutEffect.call(void 0, () => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    ...
    const getAutoSelectIdProp = _TM5Y6AJUcjs.useEvent.call(void 0, getAutoSelectId);
    ...
    _TM5Y6AJUcjs.useUpdateEffect.call(void 0, () => {
      var _a2, _b2;
    ...
    const showOnChangeProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, showOnChange != null ? showOnChange : canShow);
    const setValueOnChangeProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, 
    ...
    const onCompositionEnd = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = true;
    ...
    const blurActiveItemOnClickProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, 
      blurActiveItemOnClick != null ? blurActiveItemOnClick : () => !!(store == null ? void 0 : store.getState().includesBaseElement)
    );
    const setValueOnClickProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, setValueOnClick);
    const showOnClickProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, showOnClick != null ? showOnClick : canShow);
    const onMouseDown = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
    ...
    const showOnKeyPressProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, showOnKeyPress != null ? showOnKeyPress : canShow);
    ...
    props = _BUKUAI2Fcjs.useComposite.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      store,
      focusable
    }, props), {
...
var Combobox = _MFAH5VLWcjs.forwardRef.call(void 0, function Combobox2(props) {
