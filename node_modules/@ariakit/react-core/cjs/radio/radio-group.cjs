...
var _SWLXIU2Qcjs = require('../__chunks/SWLXIU2Q.cjs');
...
var TagName = "div";
var useRadioGroup = _MFAH5VLWcjs.createHook.call(void 0, 
  function useRadioGroup2(_a) {
    var _b = _a, { store } = _b, props = _7EQBAZ46cjs.__objRest.call(void 0, _b, ["store"]);
    const context = _SWLXIU2Qcjs.useRadioProviderContext.call(void 0, );
    store = store || context;
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _SWLXIU2Qcjs.RadioScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = _7EQBAZ46cjs.__spreadValues.call(void 0, {
      role: "radiogroup"
    }, props);
    props = _BUKUAI2Fcjs.useComposite.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var RadioGroup = _MFAH5VLWcjs.forwardRef.call(void 0, function RadioGroup2(props) {
