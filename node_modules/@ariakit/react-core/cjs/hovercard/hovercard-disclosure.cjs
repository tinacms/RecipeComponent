...
var _4RLNADFKcjs = require('../__chunks/4RLNADFK.cjs');
require('../__chunks/LSQ5XROE.cjs');
require('../__chunks/XHEEGBWU.cjs');
require('../__chunks/BBHOBWVO.cjs');


var _RREOTJCIcjs = require('../__chunks/RREOTJCI.cjs');
...
var _CSAYKKWDcjs = require('../__chunks/CSAYKKWD.cjs');
...
var TagName = "button";
var useHovercardDisclosure = _MFAH5VLWcjs.createHook.call(void 0, function useHovercardDisclosure2(_a) {
  ...
  const { style } = _CSAYKKWDcjs.useVisuallyHidden.call(void 0, );
  if (!visible) {
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, props), {
      style: _7EQBAZ46cjs.__spreadValues.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, style), props.style)
    });
  }
  ...
  props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    ...
    ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, store.setDisclosureElement, props.ref),
    onClick,
    onFocus
  });
...
var HovercardDisclosure = _MFAH5VLWcjs.forwardRef.call(void 0, function HovercardDisclosure2(props) {
