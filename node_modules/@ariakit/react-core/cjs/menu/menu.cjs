...
var _PHDY3E7Pcjs = require('../__chunks/PHDY3E7P.cjs');


var _FKDBPJ3Jcjs = require('../__chunks/FKDBPJ3J.cjs');
require('../__chunks/H3K3UH33.cjs');
require('../__chunks/NEZR6RYD.cjs');
require('../__chunks/BUKUAI2F.cjs');
require('../__chunks/MIBORXQW.cjs');
require('../__chunks/2P3WACML.cjs');
require('../__chunks/UJOJUNIC.cjs');


var _4ZYQLOONcjs = require('../__chunks/4ZYQLOON.cjs');
require('../__chunks/L6CLLK7R.cjs');
require('../__chunks/WHHEJNY4.cjs');
...
var TagName = "div";
var useMenu = _MFAH5VLWcjs.createHook.call(void 0, function useMenu2(_a) {
  var _b = _a, {
    store,
  ...
  const _a2 = _PHDY3E7Pcjs.useMenuList.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    store,
    alwaysVisible
  ...
  const contentElement = _Y7UE4JBRcjs.useStoreState.call(void 0, 
    store.combobox || store,
    "contentElement"
  );
  const parentContentElement = _Y7UE4JBRcjs.useStoreState.call(void 0, 
  ...
  props = _4ZYQLOONcjs.useHovercard.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    store,
    alwaysVisible,
...
var Menu = _O2OGPECXcjs.createDialogComponent.call(void 0, 
  _MFAH5VLWcjs.forwardRef.call(void 0, function Menu2(props) {
    const htmlProps = useMenu(props);
    return _MFAH5VLWcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _FKDBPJ3Jcjs.useMenuProviderContext
);
