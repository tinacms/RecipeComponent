...
var _KWX2D5VIcjs = require('../__chunks/KWX2D5VI.cjs');
require('../__chunks/EVB266LV.cjs');
...
var TagName = "hr";
var useMenuSeparator = _MFAH5VLWcjs.createHook.call(void 0, 
  function useMenuSeparator2(_a) {
    var _b = _a, { store } = _b, props = _7EQBAZ46cjs.__objRest.call(void 0, _b, ["store"]);
    const context = _FKDBPJ3Jcjs.useMenuContext.call(void 0, );
    store = store || context;
    props = _KWX2D5VIcjs.useCompositeSeparator.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var MenuSeparator = _MFAH5VLWcjs.forwardRef.call(void 0, function MenuSeparator2(props) {
