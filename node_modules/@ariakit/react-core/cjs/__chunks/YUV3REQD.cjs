...
var TagName = "div";
var useComboboxList = _MFAH5VLWcjs.createHook.call(void 0, 
  function useComboboxList2(_a) {
    ...
    const scopedContext = _BB26STNRcjs.useComboboxScopedContext.call(void 0, true);
    const context = _BB26STNRcjs.useComboboxContext.call(void 0, );
    store = store || context;
    ...
    const role = _TM5Y6AJUcjs.useAttribute.call(void 0, ref, "role", props.role);
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _BB26STNRcjs.ComboboxScopedContextProvider, { value: store, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _BB26STNRcjs.ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, setContentElement, ref, props.ref),
      style
    });
    return _misc.removeUndefinedValues.call(void 0, props);
  }
);
var ComboboxList = _MFAH5VLWcjs.forwardRef.call(void 0, function ComboboxList2(props) {
