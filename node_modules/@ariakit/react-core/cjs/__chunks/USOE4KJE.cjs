...
var _BBHOBWVOcjs = require('./BBHOBWVO.cjs');
...
var useCompositeItem = _MFAH5VLWcjs.createHook.call(void 0, 
  function useCompositeItem2(_a) {
    ...
    const row = _react.useContext.call(void 0, _2P3WACMLcjs.CompositeRowContext);
    const rowId = _Y7UE4JBRcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const onBlurCapture = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
    ...
    const preventScrollOnKeyDownProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, preventScrollOnKeyDown);
    const moveOnKeyPressProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, moveOnKeyPress);
    ...
    const baseElement = _Y7UE4JBRcjs.useStoreState.call(void 0, 
      store,
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _2P3WACMLcjs.CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    const isActiveItem = _Y7UE4JBRcjs.useStoreState.call(void 0, 
      store,
      (state) => !!state && state.activeId === id
    );
    const ariaSetSize = _Y7UE4JBRcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _Y7UE4JBRcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = _Y7UE4JBRcjs.useStoreState.call(void 0, store, (state) => {
      var _a2;
    ...
    props = _BBHOBWVOcjs.useCommand.call(void 0, props);
    props = _EPRWVKECcjs.useCollectionItem.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
      shouldRegisterItem: id ? props.shouldRegisterItem : false
    }));
    return _misc.removeUndefinedValues.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, props), {
      "aria-setsize": ariaSetSize,
      "aria-posinset": ariaPosInSet
    }));
  }
);
var CompositeItem = _MFAH5VLWcjs.memo.call(void 0, 
  _MFAH5VLWcjs.forwardRef.call(void 0, function CompositeItem2(props) {
