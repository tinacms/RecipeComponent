...
function useKeyboardEventProxy(store, onKeyboardEvent, previousElementRef) {
  return _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
    var _a;
...
var useComposite = _MFAH5VLWcjs.createHook.call(void 0, 
  function useComposite2(_a) {
    ...
    const context = _2P3WACMLcjs.useCompositeProviderContext.call(void 0, );
    store = store || context;
    ...
    const [, setBaseElement] = _TM5Y6AJUcjs.useTransactionState.call(void 0, 
    ...
    const onFocusCapture = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _2P3WACMLcjs.CompositeContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, ref, setBaseElement, props.ref),
      onKeyDownCapture,
      onKeyUpCapture,
      onFocusCapture,
      onFocus,
    ...
    props = _XFOTDXSHcjs.useFocusable.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { focusable }, props));
    return props;
  }
);
var Composite = _MFAH5VLWcjs.forwardRef.call(void 0, function Composite2(props) {
