...
function useMenubarStoreProps(store, update, props) {
  return _AY7QMXP6cjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useMenubarStore(props = {}) {
  const [store, update] = _Y7UE4JBRcjs.useStore.call(void 0, Core.createMenubarStore, props);
