...
var _ENNAUHNHcjs = require('./ENNAUHNH.cjs');
...
function useEventOutside({
  ...
  const callListener = _TM5Y6AJUcjs.useEvent.call(void 0, listener);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onEvent = (event) => {
      ...
      if (focused && !_WWQLUY5Wcjs.isElementMarked.call(void 0, target, contentElement.id)) return;
      if (_XFOTDXSHcjs.isSafariFocusAncestor.call(void 0, target)) return;
      callListener(event);
    };
...
function useHideOnInteractOutside(store, hideOnInteractOutside, domReady) {
  const open = _Y7UE4JBRcjs.useStoreState.call(void 0, store, "open");
  const previousMouseDownRef = _ENNAUHNHcjs.usePreviousMouseDownRef.call(void 0, open);
  const props = { store, domReady, capture: true };
  useEventOutside(_7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, props), {
    type: "click",
    listener: (event) => {
      const { contentElement } = store.getState();
      ...
      if (!_WWQLUY5Wcjs.isElementMarked.call(void 0, previousMouseDown, contentElement == null ? void 0 : contentElement.id)) return;
