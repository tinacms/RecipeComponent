...
var useFocusable = _MFAH5VLWcjs.createHook.call(void 0, 
  function useFocusable2(_a) {
    ...
    const onKeyDownCapture = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
    ...
    const autoFocusRef = _TM5Y6AJUcjs.useEvent.call(void 0, (element) => {
      if (!focusable) return;
      if (!autoFocus) return;
      if (!element) return;
    ...
    const tagName = _TM5Y6AJUcjs.useTagName.call(void 0, ref);
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
      style,
...
var Focusable = _MFAH5VLWcjs.forwardRef.call(void 0, function Focusable2(props) {
