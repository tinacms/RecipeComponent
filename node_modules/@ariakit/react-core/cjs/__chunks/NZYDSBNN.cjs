...
var _ERZMIQMYcjs = require('./ERZMIQMY.cjs');
...
var useCheckbox = _MFAH5VLWcjs.createHook.call(void 0, 
  function useCheckbox2(_a) {
    ...
    const context = _ERZMIQMYcjs.useCheckboxContext.call(void 0, );
    store = store || context;
    const [_checked, setChecked] = _react.useState.call(void 0, defaultChecked != null ? defaultChecked : false);
    const checked = _Y7UE4JBRcjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _BBHOBWVOcjs.useCommand.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { clickOnEnter: !nativeCheckbox }, props));
...
var Checkbox = _MFAH5VLWcjs.forwardRef.call(void 0, function Checkbox2(props) {
