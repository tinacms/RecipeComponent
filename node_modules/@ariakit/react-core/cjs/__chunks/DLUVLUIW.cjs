...
var _EPHIWWY3cjs = require('./EPHIWWY3.cjs');
...
var useDisclosureContent = _MFAH5VLWcjs.createHook.call(void 0, function useDisclosureContent2(_a) {
  var _b = _a, { store, alwaysVisible } = _b, props = _7EQBAZ46cjs.__objRest.call(void 0, _b, ["store", "alwaysVisible"]);
  const context = _EPHIWWY3cjs.useDisclosureProviderContext.call(void 0, );
  store = store || context;
  ...
  const otherElement = _Y7UE4JBRcjs.useStoreState.call(void 0, store.disclosure, "contentElement");
  ...
  props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _E3JIN4WHcjs.DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
  ...
  props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    ...
    ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, id ? store.setContentElement : null, ref, props.ref),
    style
  });
  return _misc.removeUndefinedValues.call(void 0, props);
});
var DisclosureContentImpl = _MFAH5VLWcjs.forwardRef.call(void 0, function DisclosureContentImpl2(props) {
  const htmlProps = useDisclosureContent(props);
  return _MFAH5VLWcjs.createElement.call(void 0, TagName, htmlProps);
});
var DisclosureContent = _MFAH5VLWcjs.forwardRef.call(void 0, function DisclosureContent2(_a) {
  var _b = _a, {
    unmountOnHide
