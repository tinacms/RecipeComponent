...
var _UJOJUNICcjs = require('./UJOJUNIC.cjs');
...
function useCollectionRenderer(_a) {
  ...
  var _a2, _b2;
  const context = _UJOJUNICcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _Y7UE4JBRcjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _TM5Y6AJUcjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _TM5Y6AJUcjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _TM5Y6AJUcjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
...
var CollectionRenderer = _MFAH5VLWcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
