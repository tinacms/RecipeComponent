...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _TM5Y6AJUcjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _TM5Y6AJUcjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  ...
  const updateStore = _TM5Y6AJUcjs.useEvent.call(void 0, () => {
