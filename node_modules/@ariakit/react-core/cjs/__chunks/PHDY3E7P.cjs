...
var _FKDBPJ3Jcjs = require('./FKDBPJ3J.cjs');


var _NEZR6RYDcjs = require('./NEZR6RYD.cjs');


var _BUKUAI2Fcjs = require('./BUKUAI2F.cjs');
...
function useAriaLabelledBy(_a) {
  ...
  const disclosureElement = _Y7UE4JBRcjs.useStoreState.call(void 0, store, "disclosureElement");
...
var useMenuList = _MFAH5VLWcjs.createHook.call(void 0, 
  function useMenuList2(_a) {
    var _b = _a, { store, alwaysVisible, composite } = _b, props = _7EQBAZ46cjs.__objRest.call(void 0, _b, ["store", "alwaysVisible", "composite"]);
    const context = _FKDBPJ3Jcjs.useMenuProviderContext.call(void 0, );
    store = store || context;
    ...
    const isMenubarHorizontal = _Y7UE4JBRcjs.useStoreState.call(void 0, 
      parentMenubar,
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _FKDBPJ3Jcjs.MenuScopedContextProvider, { value: store, children: element }),
      [store]
    );
    const ariaLabelledBy = useAriaLabelledBy(_7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
    const mounted = store.useState("mounted");
    const hidden = _DLUVLUIWcjs.isHidden.call(void 0, mounted, props.hidden, alwaysVisible);
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, id ? store.setContentElement : null, props.ref),
      style,
      onKeyDown
    });
    ...
    props = _BUKUAI2Fcjs.useComposite.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, composite }, props));
    props = _NEZR6RYDcjs.useCompositeTypeahead.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, typeahead: !hasCombobox }, props));
    return props;
  }
);
var MenuList = _MFAH5VLWcjs.forwardRef.call(void 0, function MenuList2(props) {
