...
var _72JGZWYPcjs = require('../__chunks/72JGZWYP.cjs');
require('../__chunks/2P3WACML.cjs');
require('../__chunks/UJOJUNIC.cjs');


var _SY6ACUYScjs = require('../__chunks/SY6ACUYS.cjs');
...
var TagName = "button";
var useTagRemove = _MFAH5VLWcjs.createHook.call(void 0, 
  function useTagRemove2(_a) {
    ...
    const context = _72JGZWYPcjs.useTagContext.call(void 0, );
    store = store || context;
    ...
    const setRemoveId = _react.useContext.call(void 0, _72JGZWYPcjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _72JGZWYPcjs.TagValueContext);
    ...
    const removeOnClickProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, removeOnClick);
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _SY6ACUYScjs.Role.span, { render: props.render }) : props.render
    });
    return props;
  }
);
var TagRemove = _MFAH5VLWcjs.forwardRef.call(void 0, function TagRemove2(props) {
