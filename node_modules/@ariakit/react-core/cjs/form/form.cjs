...
var useForm = _MFAH5VLWcjs.createHook.call(void 0, function useForm2(_a) {
  var _b = _a, {
    store,
  ...
  const defaultValues = _TM5Y6AJUcjs.useInitialValue.call(void 0, values);
  ...
  const onSubmit = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
  ...
  const onReset = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
  ...
  props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _EVFHZIIBcjs.FormScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var Form = _MFAH5VLWcjs.forwardRef.call(void 0, function Form2(props) {
