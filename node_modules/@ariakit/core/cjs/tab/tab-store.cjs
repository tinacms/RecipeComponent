...
function createTabStore(_a = {}) {
  ...
  const store = _BSLRW6E7cjs.mergeStore.call(void 0, 
    props.store,
    _BSLRW6E7cjs.omit.call(void 0, parentComposite, independentKeys),
  ...
  const panels = _G2NIRMCLcjs.createCollectionStore.call(void 0, );
  ...
  const tab = _BSLRW6E7cjs.createStore.call(void 0, initialState, composite, store);
  _BSLRW6E7cjs.setup.call(void 0, 
    tab,
    () => _BSLRW6E7cjs.sync.call(void 0, tab, ["moves"], () => {
  ...
  _BSLRW6E7cjs.setup.call(void 0, 
    tab,
    () => _BSLRW6E7cjs.batch.call(void 0, tab, ["selectedId"], (state, prev) => {
      if (!syncActiveId) {
        syncActiveId = true;
        return;
      }
  ...
  _BSLRW6E7cjs.setup.call(void 0, 
    tab,
    () => _BSLRW6E7cjs.sync.call(void 0, tab, ["selectedId", "renderedItems"], (state) => {
  ...
  _BSLRW6E7cjs.setup.call(void 0, 
    tab,
    () => _BSLRW6E7cjs.sync.call(void 0, tab, ["renderedItems"], (state) => {
      const tabs = state.renderedItems;
      if (!tabs.length) return;
      return _BSLRW6E7cjs.sync.call(void 0, panels, ["renderedItems"], (state2) => {
  ...
  _BSLRW6E7cjs.setup.call(void 0, tab, () => {
    ...
    if (parentComposite && "setSelectElement" in parentComposite) {
      return _MLCPLY2Pcjs.chain.call(void 0, 
        _BSLRW6E7cjs.sync.call(void 0, parentComposite, ["value"], backupSelectedId),
        _BSLRW6E7cjs.sync.call(void 0, parentComposite, ["mounted"], restoreSelectedId)
      );
    }
    if (!combobox) return;
    return _MLCPLY2Pcjs.chain.call(void 0, 
      _BSLRW6E7cjs.sync.call(void 0, combobox, ["selectedValue"], backupSelectedId),
      _BSLRW6E7cjs.sync.call(void 0, combobox, ["mounted"], restoreSelectedId)
    );
  });
